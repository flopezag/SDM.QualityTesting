...
class CheckExamples:
    ...
    def check_fl_examples(self, tz, test_number):
        ...
        for checking_file in self.CHECK_EXAMPLES:
            ...
            raw_example_url = create_example_url_raw(self.data_model_repo_url, checking_file)
        ...
        try:
            ...
            generate_examples(create_example_url_raw(self.data_model_repo_url, 'example-normalized.json'),
                              create_example_url_raw(self.data_model_repo_url, 'example-normalized.jsonld'),
